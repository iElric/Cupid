defmodule Cupid.PhotosTest do
  ...
  describe "photos" do
    ...
    @valid_attrs %{desc: "some desc", filename: "some filename", uuid: "some uuid"}
    @update_attrs %{desc: "some updated desc", filename: "some updated filename", uuid: "some updated uuid"}
    @invalid_attrs %{desc: nil, filename: nil, uuid: nil}
